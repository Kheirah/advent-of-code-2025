...
const size = sortedDistances.length;
const groups = [];
let groupName = 0;
const lastTwoJunctions = [];
...
for (let i = 0; i < size; i++) {
	...
	lastTwoJunctions[0] = j1;
	lastTwoJunctions[1] = j2;
}
...
console.log(lastTwoJunctions[0][0] * lastTwoJunctions[1][0]);

/* 8520040659 is correct */
